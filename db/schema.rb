...
ActiveRecord::Schema[7.1].define(version: 2026_02_16_153900) do
  ...
  create_table "contacts", id: :serial, force: :cascade do |t|
    ...
    t.bigint "company_id"
    t.boolean "sended_to_odoo", default: false, null: false
  ...
  create_table "odoos", force: :cascade do |t|
    t.bigint "account_id", null: false
    ...
    t.index ["account_id"], name: "index_odoos_on_account_id"
  end
  ...
  add_foreign_key "odoos", "accounts"
